...
var SLACK_WEBHOOK_POST_URL = SpreadsheetApp.getActiveSpreadsheet()
  .getRangeByName("webhook")
  .getValue();
var SLACK_WEBHOOK_TEST_URL = SpreadsheetApp.getActiveSpreadsheet()
  .getRangeByName("webhookdmz")
  .getValue();
...
function testSlack() {
  var response = {
    ...
    "What message do you want to deliver to the target audience?": [
      "the best message"
    ],
    "Goal - Member gets Member": [],
    "Email Address": ["test@mobilevikings.be"]
  };
  sendToSlack(response, "test");
}
