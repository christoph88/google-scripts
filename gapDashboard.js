...
function createDateArray(){
  var startDt = spreadsheet.getRangeByName('startDate').getValue();
  var endDt = spreadsheet.getRangeByName('endDate').getValue();
  var nDays = dateDiff(startDt, endDt);
  var array = []; 

  for (i = 0; i <= nDays; i++) { 
    var newDate = addDays(startDt, i);
    array.push(newDate);
  }
...
function getGAPprofileID(pagepath) {
  //return 'ga:109751388'; //CPBE
  return 'ga:109766484'; //CPNL
}
